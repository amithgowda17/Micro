...
public class CarDto {
	...
	public CarDto(String showRoomName, String customerName, String showRoomAddress, String customerAddress,
	...
	public int getTotalBrands() {
		System.out.println("totalBrands==="+totalBrands);
		return totalBrands;
	}
	...
	public long getShowRoomNumber() {
		System.out.println("showRoomNumber==="+showRoomNumber);
	...
	public boolean getIfDataValid() {
		System.out.println("ifDataValid==="+ifDataValid);
		return ifDataValid;
	}
	...
	public String toString() {
		return "CarDto [showRoomName=" + showRoomName + ", customerName=" + customerName + ", showRoomAddress="
